        ...
        <div className={clsx(
            ...
            {board.map((row, rowIndex) =>
                row.map((cellValue, colIndex) => {
                    ...
                    const isWrong = cellValue !== null && !isInitial && cellValue !== solvedBoard[rowIndex][colIndex];
                    ...
                    return (
                        <motion.div
                            ...
                            } : { delay: (rowIndex * 9 + colIndex) * 0.002 }}
                            ...
                            className={clsx(
                                ...
                                isWrong
                                    ? isGlass ? 'text-red-400 font-black' : 'text-red-600 font-bold'
                                    : isSelected
                                        ? isGlass
